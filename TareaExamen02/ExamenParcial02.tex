...
%%%%%% ENCABEZADO %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            ...
            Regla para números: Un número se evalúa a sí mismo
            \begin{center}
                \Large{$\frac{}{n\hspace{0.1cm}\Downarrow\hspace{0.1cm}n}$}
            \end{center}
            
            Regla para operadores (op) y expresiones (sym rpn) con operadores:\\
            ...
            Regla para espresiones vacía($\epsilon$):Una expresión vacía no tiene valor\\
            ...
            \begin{enumerate}
                ...
                \item Regla para espreciones vacías($\epsilon$):\\
